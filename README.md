...
![This is how person A and person B send messages to each other]([https://myoctocat.com/assets/images/base-octocat.svg](https://github.com/AffePelz/Cryptography/blob/main/RSA_illustration.png))
## **Assignment 1**
